...
char alu(Statusflags& object, int addsuborlogic=0, char ACC = 0x00, char Databus = 0x00, int addsub = 0, int Csel = 0, int logic = 0){
    int output=0x00; // output will be the value that gets returned
	char Cin = 0;
